...
# Configuration
TOKEN = "7749911343:AAH3scChViuZ6wpcHTqZd4BMgkqX0lP5Q2I"  # Replace with your Telegram bot token
ADMIN_IDS = {5193216992}  # Replace with your actual admin user ID(s)

# MongoDB setup
mongo_client = pymongo.MongoClient("mongodb+srv://Noah:Noah123@noah.wrhhw.mongodb.net/?retryWrites=true&w=majority&appName=Noah")
